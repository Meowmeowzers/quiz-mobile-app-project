...
class AffirmationsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_affirmation_item_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyAffirmationsRecyclerViewAdapter(PlaceholderContent.ITEMS)
            }
        }
        return view
    }
