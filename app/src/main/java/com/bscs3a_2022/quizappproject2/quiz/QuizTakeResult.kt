...
import com.bscs3a_2022.quizappproject2.databinding.QuizTakeResultBinding
...
class QuizTakeResult : Fragment() {
    private var _binding: QuizTakeResultBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = QuizTakeResultBinding.inflate(inflater, container, false)
        (activity as AppCompatActivity).supportActionBar?.title = "Quiz Result"
